...
CowInfo.push({Name:'English Longhorn', 		Rarity:"Rarity_Poor", 		Cow_image: 'sprite_English Longhorn_cow.png', 	Bull_image: 'mk2_bull2.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Aberdeen Angus', 		Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Aberdeen Angus_cow.png', 	Bull_image: 'mk2_bull3.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Holstein Friesian', 	Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Holstein Friesian_cow.png', 	Bull_image: 'mk2_bull4.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Belgian Blue',			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Belgian Blue_cow.png', 		Bull_image: 'belgian_blue_bull.png', 			Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Hereford',				Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Hereford_cow.png', 			Bull_image: 'Hereford_bull.png', 				Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Glocester',				Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Glocester_cow.png', 			Bull_image: 'glocester_bull.png', 				Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Semmental',				Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Semmental_cow.png', 			Bull_image: 'semmental_bull.png', 				Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Irish Moiled',			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Irish Moiled_cow.png', 		Bull_image: 'irish_moiled_bull.png', 			Bull_Name: 'Bull',			Is_Sprite: 'YES'});
...
CowInfo.push({Name:'Charolais', 			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Charolais_cow.png', 			Bull_image: 'mk2_bull5.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Speckle Park',			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Speckle Park_cow.png', 		Bull_image: 'speckle_park_bull.png', 			Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Texas Longhorn',		Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Texas Longhorn_cow.png', 	Bull_image: 'Texas_longhorn_bull.png', 			Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Ankole-Watusi',			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Ankole-Watusi_cow.png', 		Bull_image: 'ankole-watusi_bull.png', 			Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'White Park',			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_White Park_cow.png', 		Bull_image: 'white_park_bull.png', 				Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Scottish Highland', 	Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Scottish Highland_cow.png', 	Bull_image: 'mk2_bull7.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Lakenvelder',			Rarity:"Rarity_Poor", 		Cow_image: 'sprite_Lakenvelder_cow.png', 		Bull_image: 'lakenvelder_bull.png', 			Bull_Name: 'Bull',			Is_Sprite: 'YES'});
/*"normal cows" end weird cows start*/
CowInfo.push({Name:'Australian Longhorn', 	Rarity:"Rarity_Common", 	Cow_image: 'sprite_Australian_Longhorn_cow.png',Bull_image: 'mk2_bull10.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Mammuthus primigenius',	Rarity:"Rarity_Common", 	Cow_image: 'sprite_Mammuth_cow.png', 			Bull_image: 'mk2_bull9.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Cowabunga', 			Rarity:"Rarity_Common", 	Cow_image: 'sprite_Cowabunga_cow.png', 			Bull_image: 'mk2_bull11.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Bit-Cow', 				Rarity:"Rarity_Common", 	Cow_image: 'bit_cow.png', 						Bull_image: 'bit_bull.png', 					Bull_Name: 'Bull',			Is_Sprite: 'NO'});
CowInfo.push({Name:'Moostache', 			Rarity:"Rarity_Common", 	Cow_image: 'sprite_Moostache_cow.png', 			Bull_image: 'moostache_bull.png', 				Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Lacertilia Bos Taurus',	Rarity:"Rarity_Common", 	Cow_image: 'sprite_lizard_cow.png', 			Bull_image: 'mk2_bull8.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'See-Cow', 				Rarity:"Rarity_Common", 	Cow_image: 'sprite_See-Cow_cow.png', 			Bull_image: 'mk2_bull12.png', 					Bull_Name: 'See-Bull',		Is_Sprite: 'YES'});
...
CowInfo.push({Name:'Moose Cow',				Rarity:"Rarity_Common", 	Cow_image: 'sprite_Moose_cow.png', 				Bull_image: 'Moose-Bull.png', 					Bull_Name: 'Moose Bull',	Is_Sprite: 'YES'});
CowInfo.push({Name:'Red Cower-Ranger', 		Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Red Cower-Ranger_cow.png', 	Bull_image: 'red_cower_ranger_bull.png', 		Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Blue Cower-Ranger', 	Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Blue Cower-Ranger_cow.png', 	Bull_image: 'blue_cower_ranger_bull.png', 		Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Pink Cower-Ranger', 	Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Pink Cower-Ranger_cow.png', 	Bull_image: 'pink_cower_ranger_bull.png', 		Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Yellow Cower-Ranger', 	Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Yellow Cower-Ranger_cow.png',Bull_image: 'yellow_cower_ranger_bull.png', 	Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Black Cower-Ranger', 	Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Black Cower-Ranger_cow.png', Bull_image: 'black_cower_ranger_bull.png', 		Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Bite-Cow', 				Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Bite_cow.png', 				Bull_image: 'bite_bull.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
...
CowInfo.push({Name:'Peregrine Cow',			Rarity:"Rarity_Uncommon", 	Cow_image: 'sprite_Peregrine_cow.png', 			Bull_image: 'Falcon_bull.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
...
CowInfo.push({Name:'White Cower-Ranger', 	Rarity:"Rarity_Rare", 		Cow_image: 'sprite_White Cower-Ranger.png', 	Bull_image: 'white_cower_ranger_bull.png', 		Bull_Name: 'Bull',			Is_Sprite: 'YES'});
...
CowInfo.push({Name:'Glacial-Cow', 			Rarity:"Rarity_Rare", 		Cow_image: 'sprite_Glacial_cow.png', 			Bull_image: 'mk2_bull13.png', 					Bull_Name: 'Glacial-Bull',	Is_Sprite: 'YES'});
...
CowInfo.push({Name:'Trojan-Cow',			Rarity:"Rarity_Epic", 		Cow_image: 'sprite_Trojan_cow.png', 			Bull_image: 'Trojan_bull.png', 					Bull_Name: 'Trojan-Bull',	Is_Sprite: 'YES'});
CowInfo.push({Name:'Sobek', 				Rarity:"Rarity_Legendary", 	Cow_image: 'sprite_Sobek_cow.png', 				Bull_image: 'sobek_bull.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Ra', 					Rarity:"Rarity_Legendary", 	Cow_image: 'sprite_Ra_cow.png', 				Bull_image: 'Ra_bull.png', 						Bull_Name: 'Bull',			Is_Sprite: 'YES'});
CowInfo.push({Name:'Hathor', 				Rarity:"Rarity_Legendary", 	Cow_image: 'sprite_Hathor_cow.png', 			Bull_image: 'hathor_bull.png', 					Bull_Name: 'Bull',			Is_Sprite: 'YES'});
/*cows end*/
